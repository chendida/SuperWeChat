...
import cn.ucai.superwechat.customview.ActionItem;
import cn.ucai.superwechat.customview.TitlePopup;
...
public class MainActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showExceptionDialogFromIntent(getIntent());//显示Dialog
    ...
    private void initFragment() {
        ...
        adapter.addFragment(mineFragment, getString(R.string.me));
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        L.e(TAG, "onPageScrolled,position = " + position + ",positionOffset = "
    ...
    public void onPageScrollStateChanged(int state) {
        L.e(TAG, "onPageScrollStateChanged,state = " + state);
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        boolean isChat = intent.getBooleanExtra(I.CHAT_TO_MAINACTIVTY, false);
        if (isChat){
            layoutTabhost.setChecked(0);
